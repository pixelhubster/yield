...
const Navbar = () => {
   ...
   ">
            ...
            <input type="search" name="ens" id="" className="w-full h-full px-2 outline-none text-black focus-within:text-black bg-white peer/active" autoComplete='off' placeholder="ens.base.eth" value={query} onChange={handleInputChange} />
