...
const BorrowModal = () => {
   ...
   const handleClick = async () => {
      try {
         ...
         const res = await yieldLendingContract.methods.borrow(value.tokenId, value.qty, stringToBytes(""), value.minLoadAmount, value.maxLiquidation).send({ from: account.address});
      ...
      <>
         ...
         <div className="modal bg-white text-black" role="dialog">
            <div className="modal-box bg-white pt-2">
               ...
               <InputWithLabel value='minLoadAmount' onChange={handleChange} name='MLA' placeholder='Min Load Amount' />
