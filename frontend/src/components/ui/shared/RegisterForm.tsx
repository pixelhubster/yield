...
export default function FarmingAndForm({ name }:{name:string}) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4" id={name}>
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-between">
            <div>
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-3xl font-bold text-green-800">Yield</h1>
              </div>
              <h2 className="text-2xl font-semibold mb-4">Apex of Decentralization</h2>
              <p className="text-gray-600 mb-6">
                 Yield is a contemporary agricultural brand that embodies modern farming techniques and sustainability. Focused on innovative practices and high-quality produce, Yield offers a refined approach to farming that blends timeless traditions with cutting-edge technology.
              </p>
            </div>
            {/* <div>
